...
await invokeDenoNodeJSTransformer({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/adler32-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/adler32-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/adler32-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
